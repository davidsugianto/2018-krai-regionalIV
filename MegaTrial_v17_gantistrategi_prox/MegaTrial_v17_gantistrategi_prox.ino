//Mega trial fix v17 tambah proximity untuk ngambil kok nya lebih cepat selesai
...
v = 148, v1 = 40, v2 = 150, v3 = 17, vrpsa = 0, vrpsb = 0;
float
...
void goTZ3()
{
  ...
  else if (jarak >= 120 && jarak <= 400)//375
  {
    stoptor(0);
    delay(1);

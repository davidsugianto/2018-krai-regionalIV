...
vrps = 0, vrps1 = 0,
v = 0, v1 = 0, v2 = 0, v3 = 0, vrpsa = 0, vrpsb = 0;
float
...
void mulai()
{
  ...
  while (control=='C')
  {
    jarak = keliling * (tengah / pulse);
    stoptor(0);
    RPSkandep(0,0,0,0.0);  RPSkanbel(0,0,0,0.0);
    RPSkirdep(0,0,0,0.0);  RPSkirbel(0,0,0,0.0);
    //stopmotor();
    delay(300);
    ambilkok();
    control='D';
...
void goTZ2()
{
  ...
  if (jarak < 520)
  {
    stoptor(0);
    delay(10);
    RPSkandep(20, 0.5, 0, 0.01);  RPSkirbel(20, 0.5, 0, 0.01);
    RPSkirdep(20, 0.5, 0, 0.01);  RPSkanbel(20, 0.5, 0, 0.01);
  }
  else if (jarak >= 530)
  {
    stoptor(0);
...
void goEmas()
{
  vrps = -60; vrps1 = -60;
  jarak = keliling * (tengah / pulse);
  if (jarak < 540 && jarak > 200)
  {
    RPSkandep(-67, 0.5, 0, 0.01);  RPSkirbel(-67, 0.5, 0, 0.01);
    RPSkirdep(-38, 0.5, 0, 0.01);  RPSkanbel(-38, 0.5, 0, 0.01);
    //control = 1;
  }
  else if (jarak <= 200 && jarak >= -250)
  {
    stoptor(0);
    delay(100);
    // softbrake(-200);
    ...
    // RPSkandep(vrps, 0.2, 0, 0.01);    RPSkanbel(vrps, 0.2, 0, 0.01);
    //control = 1;
    RPSkandep(-50, 0.2, 0, 0.01);  RPSkirbel(-42, 0.2, 0, 0.01);
    RPSkirdep(-40, 0.2, 0, 0.01);  RPSkanbel(-40, 0.2, 0, 0.01);
  }
  // else if (jarak <= -81 && jarak >= -220)
  // {
  //   // stoptor(0);
  //   // delay(5);
  //   RPSkirdep(-15, 0.2, 0, 0.01);

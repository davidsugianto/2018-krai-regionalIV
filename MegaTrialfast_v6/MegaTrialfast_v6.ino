...
void goTZ1()
{
  ...
  if (jarak > -300)
  {
    ...
    {
      RPSkandep(-74,0.3,0, 0.01);  RPSkirbel(-74, 0.3, 0, 0.01);
      RPSkirdep(70, 0.3, 0, 0.01);  RPSkanbel(70, 0.3, 0, 0.01);
    }
    control = 1;
  }
  else if (jarak <= -301 && jarak >= -467 )
  {
    RPSkandep(-34,0.3,0, 0.01);  RPSkirbel(-34, 0.3, 0, 0.01);
    RPSkirdep(30, 0.3, 0, 0.01);  RPSkanbel(30, 0.3, 0, 0.01);
    control = 1;
  }
  else if (jarak <= -468)
  {
...
void goEmas()
{
  ...
  if (jarak < 60)
  {
    RPSkandep(57, 0.5, 0, 0.01);  RPSkanbel(-64, 0.5, 0, 0.01);
    RPSkirdep(-59, 0.5, 0, 0.01);  RPSkirbel(53, 0.5, 0, 0.01);
...
void ambilkok()
{
  ...
  digitalWrite(matic5B, HIGH); delay(70); digitalWrite(matic5B, LOW);
}

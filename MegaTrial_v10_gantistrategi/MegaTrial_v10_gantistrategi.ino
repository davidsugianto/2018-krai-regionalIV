...
void mulai()
{
  ...
  if(jarak > -80)//80
  {
    ...
    // RPSkande(-60, 0.2, 0, 0.01);
    // RPSkanbel(-60, 0.2, 0, 0.01);
  }
  if(jarak <= -81 && jarak >= -177)
  {
    // stoptor(0);
    // delay(5);
...
void goTZ1()
{
  ...
  if (jarak < -190)
  {
    stoptor(0);
      delay(20);
      RPSkandep(60, 0.3 ,0, 0.01);  RPSkirbel(60, 0.3, 0, 0.01);
      RPSkirdep(68, 0.4, 0, 0.01);  RPSkanbel(63, 0.3, 0, 0.01);
    }

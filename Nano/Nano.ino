...
//  Serial.println(atas);
   ...
   {
     if (LY == 0 && LX == 128) //majupelan
     {
       //slider(maju, mundur, 0, LOW, HIGH);
       //Serial.print("aa");
     }

     if (LY == 255 && LX == 128) //mundurpelan
     {
       //slider(maju, mundur, 0, HIGH, LOW);
       //Serial.print("bb");
     }

     if (LY == 128 && LX == 0) //kiripelan
     { //Serial.print("cc");
        putar(kanan, kiri, 195, HIGH, LOW);
     }

     if (LY == 128 && LX == 255) //kananpelan
     { //Serial.print("dd");
        putar(kanan, kiri, 195, LOW, HIGH);
     }

     if (LY == 128 && LX == 128) //stopotor
     {
   ...
   if (RX != RXold || RY != RYold)
   {
     ...
     if (RY == 128 && RX == 0) //kiripelan
     { Serial.print(" "); }

     if (RY == 128 && RX == 255) //kananpelan
     { Serial.print(" "); }

     if (RY == 128 && RX == 128) //stopotor
     {
       slider(maju, mundur, 255, HIGH, HIGH);
     }

...
vrps = -80, vrps1 = -82,
v = 90, v1 = 40, v2 = 0, v3 = 0, vrpsa = 0, vrpsb = 0;
float
...
void goTZ1()
{
  ...
  {
    // RPSkandep(v, 0.3, 0, 0.01);  RPSkirbel(v, 0.3, 0, 0.01);
    // RPSkirdep(v1, 0.3, 0, 0.01);  RPSkanbel(v1, 0.3, 0, 0.01);
    // brake(20);
    stoptor(0);
    delay(5);
    RPSkandep(100, 0.3, 0, 0.01);  RPSkirbel(100, 0.3, 0, 0.01);
    RPSkirdep(40, 0.2, 0, 0.01);  RPSkanbel(40, 0.2, 0, 0.01);
  }
   else if (jarak > 126 && jarak < 330)
   {
     //stoptor(0);
...
void goTZ3()
{
  ...
  if (jarak < 80)
  {
    ...
    RPSkirdep(67, 0.2, 0, 0.01);  RPSkanbel(63, 0.2, 0, 0.01);
  }
  else if (jarak >= 80 && jarak <= 500)
  {
    stoptor(0);
    delay(5);
    RPSkandep(70, 0.5, 0, 0.01);  RPSkirbel(70, 0.5, 0, 0.01);
    RPSkirdep(38, 0.5, 0, 0.01);  RPSkanbel(38, 0.5, 0, 0.01);
  }
  else if (jarak >= 501 && jarak <= 800)
  {
    stoptor(0);
    delay(10);
    RPSkandep(40, 0.2, 0, 0.01);  RPSkirbel(40, 0.2, 0, 0.01);

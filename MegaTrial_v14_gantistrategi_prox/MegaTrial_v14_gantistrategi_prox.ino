//Mega trial fix v14 ada perubahan di waktu ngambil emas dan di tz3 fix selesai
...
vrps = -80, vrps1 = -82,
v = 120, v1 = 40, v2 = 120, v3 = 37, vrpsa = 0, vrpsb = 0;
float
...
long ltime, ltime1, ltime2, ltime3, ltime4, timer, timer1, timer2, timer3;
...
void goTZ1()
{
  ...
  if (jarak < -200)
  {
    RPSkandep(40, 0.15, 0, 0.01);  RPSkirbel(40, 0.15, 0, 0.01);
    RPSkirdep(45, 0.15, 0, 0.01);  RPSkanbel(42, 0.15, 0, 0.01);
  }
  else if (jarak > -200 && jarak < 125)
  {
    RPSkandep(v, 0.2, 0, 0.01);  RPSkirbel(v, 0.2, 0, 0.01);
    RPSkirdep(v1, 0.2, 0, 0.01);  RPSkanbel(v1, 0.2, 0, 0.01);
    brake(30);
  }
   else if (jarak >= 125 && jarak < 330)
   {
     //stoptor(0);
     RPSkandep(40, 0.2, 0, 0.01);  RPSkirbel(40, 0.2, 0, 0.01);
     RPSkirdep(40, 0.2, 0, 0.01);  RPSkanbel(40, 0.2, 0, 0.01);
   }
   else if (jarak >= 330 && jarak < 483)
   {
     stoptor(0);
     delay(50);
...
void goEmas()
{
  ...
  {
    softbrake(-200);
    RPSkirdep(vrps1, 0.2, 0, 0.01);   RPSkirbel(vrps1, 0.2, 0, 0.01);
    RPSkandep(vrps, 0.2, 0, 0.01);    RPSkanbel(vrps, 0.2, 0, 0.01);
    // RPSkirdep(-60, 0.2, 0, 0.01);
    // RPSkirbel(-60, 0.2, 0, 0.01);
    // RPSkandep(-60, 0.2, 0, 0.01);
    // RPSkanbel(-60, 0.2, 0, 0.01);
    control = 1;
  }
  else if (jarak <= -81 && jarak >= -260)
  {
    //stoptor(0);
    // delay(1);
    RPSkirdep(-15, 0.2, 0, 0.01);
    RPSkirbel(-17, 0.2, 0, 0.01);
    RPSkandep(-27, 0.2, 0, 0.01);
    RPSkanbel(-15, 0.2, 0, 0.01);
    if (jarak <= -220 && jarak >= -230)
    {
      bukakok2();
    }
    control = 1;
...
void goTZ3()
{
  ...
  {
    RPSkandep(v2, 0.2, 0, 0.01);  RPSkirbel(v2, 0.2, 0, 0.01);
    RPSkirdep(v3, 0.2, 0, 0.01);  RPSkanbel(v3, 0.2, 0, 0.01);
    softstart2(30);
    //control = 2;
  }
...
{
  analogWrite(kirdep1, LOW);
  analogWrite(kirdep2, 20);
  analogWrite(kanbel1, LOW);
  analogWrite(kanbel2, 20);
  analogWrite(kandep1, LOW);
  analogWrite(kandep2, 20);
  analogWrite(kirbel1, LOW);
  analogWrite(kirbel2, 20);
}

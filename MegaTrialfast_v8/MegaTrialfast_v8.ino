...
void goTZ1()
{
  ...
  if (jarak > -467)
  {
    stoptor(0);
    delay(10);
    RPSkandep(-94, 0.2,0, 0.01);  RPSkirbel(-94, 0.2, 0, 0.01);
    RPSkirdep(90, 0.2, 0, 0.01);  RPSkanbel(90, 0.2, 0, 0.01);
  }
  else if (jarak <= -468)
  {
    stoptor(0);
...
void goEmas()
{
  ...
  else if (jarak >= 30 && jarak <= 288)
  {
    RPSkandep(34, 0.2, 0, 0.01);  RPSkanbel(-52, 0.2, 0, 0.01);
    RPSkirdep(-39, 0.2, 0, 0.01);  RPSkirbel(33, 0.2, 0, 0.01);
    if (jarak >= 240 && jarak <= 269)
    {
      bukakok2();
    }
    control = 1;

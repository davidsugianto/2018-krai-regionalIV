//Mega trial fix v18 tz 1 otomatis
...
v = 150, v1 = 40, v2 = 80, v3 = 82, vrpsa = 0, vrpsb = 0;
float
...
void goTZ1()
{
  ...
  else if (jarak >= -160 && jarak < 185)//185
  {
  ...
  {
    RPSkandep(50, 0.2, 0, 0.01);  RPSkirbel(50, 0.2, 0, 0.01);
    RPSkirdep(50, 0.2, 0, 0.01);  RPSkanbel(50, 0.2, 0, 0.01);
  }

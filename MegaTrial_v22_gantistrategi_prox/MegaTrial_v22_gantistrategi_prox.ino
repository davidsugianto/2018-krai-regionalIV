//Mega trial fix v22 tz3dipercepat
...
v = 155, v1 = 40, v2 = 105, v3 = 107, vrpsa = 0, vrpsb = 0;
float
...
void goTZ3()
{
  ...
  if (jarak < 120)
  {
  RPSkandep(76, 0.2, 0, 0.02);  RPSkirbel(88, 0.2, 0, 0.02);
  RPSkirdep(160, 0.3, 0, 0.02);  RPSkanbel(128, 0.3, 0, 0.02);
  }
  else if (jarak >= 120 && jarak < 650)//675
  {
    stoptor(0);
    delay(1);

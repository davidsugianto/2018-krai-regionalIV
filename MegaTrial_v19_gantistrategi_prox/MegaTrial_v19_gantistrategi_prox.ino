//Mega trial fix v19 pndah lapangan tombol segitiga berjalan pelan saat ditekan kedua kalinya
...
v = 155, v1 = 40, v2 = 80, v3 = 82, vrpsa = 0, vrpsb = 0;
float
...
void goTZ3()
{
  ...
  if (jarak < 120)
  {
  RPSkandep(60, 0.2, 0, 0.02);  RPSkirbel(60, 0.2, 0, 0.02);
  RPSkirdep(101, 0.2, 0, 0.02);  RPSkanbel(85, 0.2, 0, 0.02);
    //control = 2;
  }
  else if (jarak >= 120 && jarak < 715)//375
  {
    stoptor(0);
    delay(1);
...
{
  analogWrite(kirdep1, LOW);
  analogWrite(kirdep2, 80);
  analogWrite(kanbel1, LOW);
  analogWrite(kanbel2, 80);
  analogWrite(kandep1, LOW);
  analogWrite(kandep2, 80);
  analogWrite(kirbel1, LOW);
  analogWrite(kirbel2, 80);
}

//Mega trial fix v20 perbaikan selesai fix
...
void goTZ1()
{
  ...
  else if (jarak >= -150 && jarak < 194)//185
  {
  ...
  // }
  else if (jarak >= 194 && jarak < 330)
  {
    RPSkandep(59, 0.2, 0, 0.01);  RPSkirbel(51, 0.2, 0, 0.01);
    RPSkirdep(47, 0.2, 0, 0.01);  RPSkanbel(50, 0.2, 0, 0.01);
  }

//Mega trial fix v23 tz3dipercepat
...
void goTZ1()
{
  ...
  if (jarak < -167)
  {
    ...
    RPSkirdep(65, 0.15, 0, 0.01);  RPSkanbel(55, 0.15, 0, 0.01);//65 55
  }
  else if (jarak >= -167 && jarak < 293)//150
  {
    RPSkandep(v, 0.2, 5, 0.01);  RPSkirbel(v, 0.2, 0, 0.01);
    RPSkirdep(v1, 0.25, 0, 0.01);  RPSkanbel(v1, 0.25, 0, 0.01);
    brake(30);
  }
  else if (jarak >= 293 && jarak < 330)
  {
...
void nganan()
{
  analogWrite(kirdep1, 105);
  analogWrite(kirdep2, LOW);
  analogWrite(kanbel1, 103);
  analogWrite(kanbel2, LOW);
  analogWrite(kandep1, LOW);
  analogWrite(kandep2, 100);
  analogWrite(kirbel1, LOW);
  analogWrite(kirbel2, 100);
}
